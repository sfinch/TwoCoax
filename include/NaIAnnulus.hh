...
class NaIAnnulus
{
  ...
  private:
     ...
     G4double           crystalInRad;       //inner radius
     G4double           crystalOutRad;      //outer radius

     G4double           wallInThickness;    //inner wall thickness
     G4double           wallOutThickness;   //outer wall thickness
